...
Symbol::Symbol(std::string name, uint32_t value) : Parameter(type::PARAMETER_TYPE::SYMBOL)
{
  this->name = name;
  this->value = value;
}
...
void Symbol::set_defined_flag(bool defined_flag) { this->is_defined = defined_flag; }
bool Symbol::get_defined_flag() const { return this->is_defined; }
