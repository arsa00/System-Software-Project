...
void Instruction::set_gp_regs(type::GP_REG gp_reg_0, type::GP_REG gp_reg_1)
{ 
...
type::GP_REG Instruction::get_gp_reg_0() const { return this->gp_reg_0; }
type::GP_REG Instruction::get_gp_reg_1() const { return this->gp_reg_1; }

void Instruction::set_cs_regs(type::CS_REG cs_reg_0, type::CS_REG cs_reg_1)
{ 
...
type::CS_REG Instruction::get_cs_reg_0() const { return this->cs_reg_0; } 
type::CS_REG Instruction::get_cs_reg_1() const { return this->cs_reg_1; }